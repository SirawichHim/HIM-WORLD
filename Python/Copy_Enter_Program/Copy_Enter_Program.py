...
class AutoKeywordApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Program_name") # FYI! You can change name Here
    ...
    def read_keywords(self):
        ...
        self.word_list = []  # Clear the current word list
        try:
    ...
    def run_automation(self):
        time.sleep(5)  #FYI ! You can setting time before starting Here!
